...
public class Ia extends Robot {
    ...
    private void esquivePilote(){
        ...
        while(!fini) {
            ...
            System.out.println(" ld : " +lastDepPilote);
            System.out.println(" newtr : " +nextFrist);
            for(Couple cur : filss){
            ...
            System.out.println(" chemin pilote : " +cheminPilote);
            if (cheminPilote.contains(currentPos)) {
                cheminPilote.add(previousPos);
                ...
                for(Couple cur : filss){
                    if ((cur.getSommet()==nextFrist) && (graphe.estIntersec(currentPos))) {
                        attenteBis.add(cur); }
                }
                ...
                for (i = 1; i < cheminEsquive.size() - 1; i++) {
                    envoieMouvement(i, true, cheminEsquive);
                }
